...
class EditarReservacion(tk.Toplevel):
    ...
    def __init__(self, master=None, tipo = None, identificacion = None):
        ...
        columnas = ("col1", "col2", "col3", "col4", "col5", "col6", "col7", "col8")
        ...
        self.tabla.heading("col2", text="Identificacion")
        self.tabla.heading("col3", text="ID del sitio")
        self.tabla.heading("col4", text="Fecha de entrada")
        self.tabla.heading("col5", text="Fecha de salida")
        self.tabla.heading("col6", text="Disponibilidad")
        ...
        self.lbl_precio_noche.grid(row=8, column=1, sticky="W")
    ...
    def seleccionar_reservacion_tabla(self, event):
        ...
        if item:
            ...
            self.txt_id_reserva.delete(0, tk.END)
            self.txt_id_reserva.insert(0, valores[0])
            self.txt_id.delete(0, tk.END)
            self.txt_id.insert(0, valores[1])
            self.txt_id_sitio.delete(0, tk.END)
            self.txt_id_sitio.insert(0, valores[2])
            self.txt_fecha_entrada.delete(0, tk.END)
            self.txt_fecha_entrada.insert(0, valores[3])
            self.txt_fecha_salida.delete(0, tk.END)
    ...
    def editar_reservacion(self):
        try:
            ...
            id_reserva = self.txt_id_reserva.get()
