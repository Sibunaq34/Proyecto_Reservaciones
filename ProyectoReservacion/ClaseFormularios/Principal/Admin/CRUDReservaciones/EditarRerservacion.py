...
class EditarReservacion(tk.Toplevel):
    ...
    def __init__(self, master=None):
        ...
        lbl_cantidad_personas = tk.Label(self, text="Cantidad de personas a ir:", font=("Times", 12), fg="#666a88",
                                         anchor="w")
    ...
    def editar_reservacion(self):
        try:
            ...
            if reservaciones.editar_reserva(identificacion, id_sitio, fecha_entrada, fecha_salida, disponible,
