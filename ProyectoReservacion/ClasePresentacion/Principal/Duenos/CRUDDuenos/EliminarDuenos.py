...
class EliminarDueno(tk.Toplevel): 
    ...
    def __init__(self, master=None, email=None, contrasena=None):
        ...
        self.btn_eliminar = tk.Button(self, text="Eliminar Dueños", command= self.eliminarDueno, bg="#666a88", fg="#fcfcfc")
    ...
    def mostrarDatos(self):
        ...
        dueno= xmlduenos.inicioSesion(self.email, self.contrasena)
    ...
    def eliminarDueno (self):
        ...
        dueno =  Usuarios(int(self.txt_id.get()),self.txt_nombre.get(),self.txt_apellido.get(),self.txt_email.get(),self.txt_contrasena.get(),self.txt_tipo.get())
